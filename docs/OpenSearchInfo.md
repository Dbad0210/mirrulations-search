...
# Insights
- No date in any of the dbs, do not know if that would be helpful. Could take from posted date.
- After looking into it, some sites and Claude say opensearch should not do relational db as they slow it down and suggest merging the db but I need to look into it more.